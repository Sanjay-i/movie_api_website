...
<body class="font-sans bg-gray-900 test-white">
    <nav class="bg-slate-700 dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-slate-700 dark:border-gray-600">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
                    <a href="{{ route('get.movies')}}" class="block py-2 px-3 text-orange-500 rounded hover:bg-gray-100  active:bg-rose-600 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 ">Movies</a>
                </li>
                <li>
    ...
    <div class="border-b border-gray-800 pt-8">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
    
            <img src="{{ $movieDetails['poster_path'] ? 'https://image.tmdb.org/t/p/w500'.$movieDetails['poster_path'] : asset('images/no.jpg') }}" alt="Movie Poster" class="w-62 md:w-72" >
            
            <div class="md:ml-24">
                <h2 class="text-pink-600 text-4xl font-semibold">{{ $movieDetails['title'] }}</h2>
                    ...
                    @if (count($movieDetails['videos']['results']) > 0)
                        <div class="mt-12">
                            <button
                                ...
                                data-trailer-url="https://www.youtube.com/watch?v={{ $movieDetails['videos']['results'][0]['key'] }}"
                            ...
                            <div class="bg-gray-900 rounded">
                                ...
                                <div class="modal-body px-8 py-8">
                                    <div class="aspect-w-1 aspect-h-1">
                                        <iframe width="1000" height="560" class="ps-32" id="trailerIframe" src="" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                @foreach ($movieDetails['credits']['cast'] as $cast)
                    @if ($loop->index < 5)
                        ...
                        <div class="mt-8">
                            ...
                            <div class="mt-2">
                                <a href="#" class="text-lg mt-2 text-orange-400 hover:text-gray:300 rounded-4">{{$cast['name']}}</a>
